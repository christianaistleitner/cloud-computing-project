...
## Tekton
As an open-source cloud native Continuous Integration and Deployment solution, it is applicable accross destinations using a custormised Kubernetes Cluster.
